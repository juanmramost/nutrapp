...
const SECTIONS: SectionOption[] = [
  {
    ...
    title: "Mis platos",
    description:
      "Guarda tus recetas favoritas con sus datos nutricionales, para reutilizarlas cuando quieras.",
  ...
  },
  {
    ...
    description:
      "Ideas de desayuno, almuerzo, postre y cena pensadas para tu objetivo. Se renuevan cada 5 días.",
  ...
  },
  {
    ...
    description:
      "Cuéntale a la IA qué ingredientes tienes y te propone 3 recetas distintas al momento.",
...
export function CocinaView() {
  ...
  return (
    <div className="relative">
        ...
        <div className="flex flex-col gap-5 px-4 pb-4 pt-8">
          <header>
            ...
            <p className="text-sm text-muted-foreground">
              Tu asistente para decidir, guardar y crear recetas
            </p>
          </header>
      ...
      <div className={section === "mis-platos" ? "block" : "hidden"}>
        <MisPlatosView onBack={() => setSection("menu")} />
      </div>

      <div className={section === "recomendados" ? "block" : "hidden"}>
        <RecomendadosView onBack={() => setSection("menu")} />
      </div>

      <div className={section === "que-cocinar" ? "block" : "hidden"}>
        <div className="flex flex-col gap-5 px-4 pb-4 pt-8">
          <button
            type="button"
